                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>Artificial Intelligence</h1>
                              ...
                              <b>Hey <?php echo $_SESSION['name']; ?>, you can search for or upload your AI projects here!</b>
                            </p>
			<div class="top_left">
		
	<a href="FORM_ai.php"><h3><b><button<span style="background-color: #555555; color:white;font-size: 17px; shadow:5px; padding :10px 15px; cursor: pointer;">+New Query</b></button></h3></a>
	</div>
                        </div>
                    </div>
...
$result = mysqli_query($conn,"SELECT * FROM ai_project");
?>
<?php
