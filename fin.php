                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>Finance</h1>
                                ...
                                <b>Hey <?php echo $_SESSION['name']; ?>, you can search for or upload your projects related to 'Finance' here!</b>
                            </p>
			<div class="top_left">
	<a href="FORM_fin.php"><h3><b><button<span style="background-color: #555555; color:white;font-size: 17px; shadow:5px; padding :10px 15px; cursor: pointer;">+New idea</b></button></h3></a>
	<a href="FORM2_fin.php"><h3><b><button<span style="background-color: #555555; color:white;font-size: 17px; shadow:5px; padding :10px 15px; cursor: pointer;">+Completed project</b></button></h3></a>
...
$result = mysqli_query($conn,"SELECT * FROM fin_project");
?>
<?php
