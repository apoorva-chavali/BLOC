...
<form action="FORM_wd.php" method="POST">
  ...
  <script function(){document.getElementById("p_name").value="<?php echo $_GET['p_name']; ?>";}</script>
		...
		<div class="form-container">
    		...
    		<a href="wd.php"><a href="wd.php"><button type="button" class="btn cancel" onclick="closeForm()">Close</button></a></a>
</form>
