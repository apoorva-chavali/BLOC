<?php include("insert_startup.php");?>
...
<form action="FORM_startup.php" method="POST">
  ...
  <script function(){document.getElementById("p_name").value="<?php echo $_GET['p_name']; ?>";}</script>
		...
		<div class="form-container">
    		...
    		<a href="startup.php"><button type="button" class="btn cancel" onclick="closeForm()">Close</button></a>
</form>
