       ...
       <!-- Top Bar Start -->
        ...
        <div class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
			...
			<input type="text" class="form-control" placeholder="Search" disabled name="search">
                        ...
                        <a href="dm.html"><img style="padding-top:10px;padding-left:5px;padding-right:5px;"  src="https://icon-library.com/images/message-icon-png/message-icon-png-22.jpg" width="30" height="30" ></a>
		<div class="nav-item dropdown">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>Machine Learning.</h1>
                                ...
                                Hey <?php echo $_SESSION['name']; ?>, you can upload your ML projects here!
                            </p>
			<div class="top_left">
	<a href="FORM1.php"><h3><b><button<span style="background-color: #555555; color:white;font-size: 17px; shadow:5px; padding :10px 15px; cursor: pointer;">+New project</b></button></h3></a>
	<a href="FORM2.php"><h3><b><button<span style="background-color: #555555; color:white;font-size: 17px; shadow:5px; padding :10px 15px; cursor: pointer;">+Completed Project</b></button></h3></a>
</div>
                        </div>
                    </div>
...
$result = mysqli_query($conn,"SELECT * FROM ml_project");
?>
<?php
