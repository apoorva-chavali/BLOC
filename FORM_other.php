...
<form action="FORM_other.php" method="POST">
  ...
  <script function(){document.getElementById("p_name").value="<?php echo $_GET['p_name']; ?>";}</script>
		...
		<div class="form-container">
    		...
    		<a href="other.php"><button type="button" class="btn cancel" onclick="closeForm()">Close</button></a>
</form>
